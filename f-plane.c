...
//   if(PaddlePIDGatesFlagb==1){    //only keep analyzer busy with events that pass this rough cut
   ...
   // Calculate horizontal angle through drift chamber. 
   // NOTE: figure out which VDCs are being used. 
   // here Theta is calculated by the two X-wires. 
   ...
   // Calculate Y2 pos in second Drift Chamber
